  ...
  ANALOG: {
    initialize: {
      value: function(opts, dataHandler) {
        ...
        state.aref = opts.aref || 5;
        state.zeroV = opts.zeroV || 478;
        state.sensitivity = opts.sensitivity || 96;
  ...
  MPU6050: {
    initialize: {
      value: function(opts, dataHandler) {
        ...
        state.maxValue = opts.maxValue || 17300;
  ...
  ADXL345: {
    ...
    initialize: {
      value: function(opts, dataHandler) {
        ...
        state.maxValue = opts.maxValue || 156.9064;
        // Sensitivity:
        //
        // (ADXL345_MG2G_MULTIPLIER * SENSORS_GRAVITY_STANDARD) = (0.004 * 9.80665)
        //
        // Reference:
        ...
        state.sensitivity = opts.sensitivity || 0.0390625;
    ...
    toGravity: {
      value: function(raw) {
        ...
        // https://github.com/adafruit/Adafruit_ADXL345/blob/master/Adafruit_ADXL345_U.cpp#L298-L309
        // Convert to g-units
        return (raw * state.sensitivity) / 9.8;
      }
    }
  }
};
